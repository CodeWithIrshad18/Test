...
<script>
    window.addEventListener("DOMContentLoaded", () => {
        ...
        Promise.all([
            ...
            // After models load, prepare descriptors
            ...
            // ✅ Start detection after everything is ready
        ...
        async function detectAndMatchFace(faceMatcher, matchMode) {
            ...
            if (detections.length === 0) {
                ...
                return requestAnimationFrame(() => detectAndMatchFace(faceMatcher, matchMode));
            }
