...
.Style.Border.OutsideBorder = XLBorderStyleValues.Thin;
              ...
              {
                  ws.Cell(groupRow, col+1).Value = "G-1";
                  ws.Cell(groupRow, col + 2).Value = "G-2";
                  ws.Cell(groupRow, col + 3).Value = "G-3";
                  col += 4;
              }
...
.Style.Border.OutsideBorder = XLBorderStyleValues.Thin;
              ...
              foreach (var t in monthTotals)
              {
                  ...
                  {
                      ws.Cell(payoutRow, col+1).Value = payout.Rows[0]["Group1"].ToString();
                      ws.Cell(payoutRow, col + 2).Value = payout.Rows[0]["Group2"].ToString();
                      ws.Cell(payoutRow, col + 3).Value = payout.Rows[0]["Group3"].ToString();
                  }
