...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // === Load sections dynamically (merge mode) ===
    ...
    refNoLinks.forEach(link => {
        link.addEventListener("click", function (event) {
            ...
            // Load and check dependent dropdowns (append mode)
